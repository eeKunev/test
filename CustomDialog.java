...
public class CustomDialog extends JDialog implements ActionListener, PropertyChangeListener {
	...
	public CustomDialog(String text, PersonDataGUI parent) {
		...
		Object[] array1 = {text, textField};
		Object[] options1 = {okLabel, cancelLabel};
		
		optionPane = new JOptionPane(array1, JOptionPane.QUESTION_MESSAGE, 
				JOptionPane.OK_CANCEL_OPTION, null, options1, options[0]);
